...
public class P02Warrior {
	...
	public void showStatus() {
		...
		System.out.println("전사 체  력: " + this.pPower);
		System.out.println("전사 마  나: " + this.mana);
		System.out.println("전사 레  벨: " + this.level);
		System.out.println("전사 공격력: " + this.attackPower);
		System.out.println("전사 방어력: " + this.defensePower);
		System.out.println("전사 경험치: " + this.exp);
	}
	...
	public void doubleAttack(P01Monster mon) {
		System.out.println(mon.getName() + " 몬스터에게 double attack을 준비합니다.");
		if(mon.getPPower() <= 0) {
			System.out.println("이미 죽은 " + mon.getName() + " 몬스터를 공격할 수 없습니다.");
			return;
		}
